...
// Use viewport dimensions instead of window
...
class Effect {
    constructor(context, canvasWidth, canvasHeight) {
        ...
        window.addEventListener('mousemove', e => {
            const rect = this.canvasWidth !== window.innerWidth ? canvas.getBoundingClientRect() : { left: 0 };
            // Robust check for canvas position
        ...
        window.addEventListener('touchmove', e => {
             const bounds = canvas.getBoundingClientRect();
             this.mouse.x = e.touches[0].clientX - bounds.left;
             this.mouse.y = e.touches[0].clientY - bounds.top;
        });
    }
